...
const newHtml = `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333333; line-height: 1.6;">
...
const newText = `Hello [[DOMAIN]] Team,
...
async function updateSEO() {
  ...
  console.log("Updated templates:", result);
